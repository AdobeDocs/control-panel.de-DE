...
Die Syntax besteht aus einer IP-Adresse, gefolgt vom Zeichen / und einer Dezimalzahl. Format und Syntax werden im Abschnitt [diesem Artikel](https://whatismyipaddress.com/cidr){target="_blank"}.
